...
if __name__ == "__main__":
    ...
    driver.find_element_by_xpath(
        "/html/body/div/div/main/div[3]/div[1]/div/div/button"
    ).click()
    ...
    for charapter in range(1, 10000):
        ...
        sleep(1)
        try:
            fa_angle = driver.find_element_by_xpath(
                "/html/body/div/div/main/div[2]/div[2]/div[1]/div[1]/div[3]/div"
            ).click()  # click next page
        except Exception as e:
            break
        sleep(
            1
        )  # delay for close registration alert, you can change value if your internet connetion is faster or even slower
        try:
            driver.find_element_by_xpath(
                "/html/body/div/div/main/div[3]/div[1]/div/div/button"
            ).click()  # close registration alert
